...
{  public:
	...
	virtual int Delete(ostream &, int recref) const = 0;
	...
	int ReadDeleteAddr(istream &);
	int WriteDeleteAddr(ostream &, int, int) const;
	virtual int FindSpace(istream &, int*, int*, unsigned short*) = 0;
